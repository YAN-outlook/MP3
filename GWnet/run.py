...
parser.add_argument('--milestones', type=list, default=[1, 18, 36, 54, 72], help='optimizer milestones')
parser.add_argument('--patience', type=int, default=18, help='early stopping')
parser.add_argument('--dropout', type=float, default=0.3, help='dropout rate')
parser.add_argument('--weight_decay', type=float, default=1.0e-5, help='weight decay rate')
